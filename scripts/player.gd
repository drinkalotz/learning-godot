...
@onready var sword_collider: CollisionShape2D = $sword/sword_collider
...
func _on_sword_area_shape_entered(area_rid: RID, area: Area2D, area_shape_index: int, local_shape_index: int) -> void:
